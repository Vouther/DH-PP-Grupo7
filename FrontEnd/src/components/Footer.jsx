export default function Example() {
    return (
        ...
        <div className="mx-6 py-10 text-center md:text-left">
            ...
            <div>
              <p className="mb-4">
                <a href="/applicants/register" className="block px-3 py-1.5 rounded-lg bg-gray-100 text-gray-800 hover:bg-gray-200">Postularse</a>
              </p>
              <p className="mb-4">
                <a href="#" className="block px-3 py-1.5 rounded-lg bg-gray-100 text-gray-800 hover:bg-gray-200">Empresas</a>
              </p>
              <p className="mb-4">
                <a href="/applicants" className="block px-3 py-1.5 rounded-lg bg-gray-100 text-gray-800 hover:bg-gray-200">Aspirantes</a>
              </p>
              <p>
                <a href="/contact" className="block px-3 py-1.5 rounded-lg bg-gray-100 text-gray-800 hover:bg-gray-200">Contacto</a>
              </p>
            </div>
            <div>
                <h6
