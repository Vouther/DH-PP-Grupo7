      ...
      <div className="pb-80 pt-16 sm:pb-40 sm:pt-24 lg:pb-48 lg:pt-40">
        <div className="relative max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          <div className="sm:max-w-lg  text-left">
            ...
            ¡Tu próximo gran trabajo te está esperando!
            </h1>
            <p className="mt-4 text-xl text-gray-500">
            Únete a nuestra plataforma y accede a miles de oportunidades laborales. Encuentra el empleo perfecto que se adapte a tus habilidades y expectativas.
